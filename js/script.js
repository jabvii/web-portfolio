...
const projects = [
    {
    id: 'Leave Request System',
    title: 'OFFDesk - Leave Request System',
    description: 'Developed a web-based leave management system that allows employees to submit leave requests and tracks approvals through supervisors, managers, and administrators.',
    technologies: ['Laravel', 'PHP', 'MySQL', 'HTML', 'CSS', 'JavaScript'],
    imageUrl: '',
    previewUrl: '',
    githubUrl: 'https://github.com/jabvii/offdesk',
    },
    {
    id: 'lorskie-store',
    title: 'Lorskie Store',
...
function createProjectCard(project) {
    ...
    <div class="project-content">
        ...
        <div class="project-actions">
            ...
            ${project.githubUrl ? `<a href="${project.githubUrl}" target="_blank" class="project-link">Source</a>` : ``}
        </div>
    </div>
    `;
